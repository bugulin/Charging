        ...
        Column(
            ...
            Row(
                ...
                if (record.startTime != null && record.endTime != null) {
                    ...
                    Text(
                        text = stringResource(R.string.duration, formatDuration(timeCharging.seconds)),
                        style = MaterialTheme.typography.headlineMedium
                    )
                }
            }
 ...
 */
@Composable
private fun FromToText(from: String, to: String, style: TextStyle, modifier: Modifier = Modifier) {
    val arrowId = "arrow"
 ...
 */
@Composable
private fun PercentageDifferenceText(value: Float, style: TextStyle, modifier: Modifier = Modifier) {
    Text(
