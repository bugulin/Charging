...
/*
 * Custom color theme generated by
...
val md_theme_dark_surfaceTint = Color(0xFFF6BE3B)
val md_theme_dark_outlineVariant = Color(0xFF4D4639)
val md_theme_dark_scrim = Color(0xFF000000)

/**
 * Color from the launcher icon, used as a custom source color for Material Theme Builder.
 */
val seed = Color(0xFFDAA520)
